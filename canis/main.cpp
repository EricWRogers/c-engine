...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char **argv)
{
    ...
    void* vertexCode = SDL_LoadFile("assets/shaders/test.vert.spv", &vertexCodeSize);
    ...
    SDL_ShaderCross_SPIRV_Info vertexInfo = {0};
    ...
    void* fragmentCode = SDL_LoadFile("assets/shaders/test.frag.spv", &fragmentCodeSize);
    ...
    SDL_ShaderCross_SPIRV_Info fragmentInfo = {0};
